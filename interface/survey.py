...
QUESTIONS = [
    ...
    "How FRUSTRATING/STRESSFUL was this mode?",
...
def run_survey(screen, S):
    ...
    while running:
        ...
        if current_question < len(QUESTIONS):
            ...
            draw_text(screen, SCALE_TEXT, font_scale, (150, 150, 150), S.WIDTH // 2, S.HEIGHT * 0.45)
            ...
            draw_text(screen, "Thank you!", font_title, (100, 255, 100), S.WIDTH // 2, S.HEIGHT // 2)
            pygame.display.flip()
